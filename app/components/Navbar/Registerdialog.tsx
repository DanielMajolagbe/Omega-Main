        ...
        <>
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto  sm:pr-0">
                <div className='hidden lg:block'>
                    <button className="navbar-button text-white text-xl font-medium ml-9 py-6 px-12 transition duration-150 ease-in-out bg-black border:black hover:text-black hover:bg-white ttty" onClick={openModal}>
                        Join Waitlist
                    </button>
                </div>
            </div>
                                        ...
                                        <div className="w-full max-w-md space-y-8">
                                            ...
                                            <form className="mt-8 space-y-6" action="#" method="POST">
                                                ...
                                                <div className="-space-y-px rounded-md shadow-sm">
                                                  ...
                                                  {/* This is a comment inside JSX  <div>
