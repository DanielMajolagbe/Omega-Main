        ...
        <div id="product">
            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 pt-1 lg:pt-8 lg:mt-2'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly lg:pl-24 mt-5 lg:mt-0'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly lg:pl-24 mt-5 lg:mt-0'>
                        ...
                        <h3 className='text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-3 lg:pt-0'>Another milestone Omega has achieved is building partnerships with several 
